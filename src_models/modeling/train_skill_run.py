"""
Train XGBoost and Ridge baseline models for the skill_run position group.

Reads:  data/features/skill_run_features_train.csv
Writes: models/saved/xgboost_skill_run.pkl
        models/saved/ridge_baseline_skill_run.pkl

Hold-out data is never loaded or referenced in this script.

Usage:
    python -m src.modeling.train_skill_run
"""
...
TRAIN_PATH = FEATURES_DIR / "skill_run_features_train.csv"
...
def main() -> None:
    """Run the full skill_run training pipeline.
    ...
    """
    print("Stage 3 — Training (skill_run)")
    ...
    ridge.fit(train, y)
    ridge_path = MODELS_DIR / "ridge_baseline_skill_run.pkl"
    ...
    xgb_path = MODELS_DIR / "xgboost_skill_run.pkl"
